...
class Product_List(models.Model):
    ...
    trader = models.ForeignKey(Traders, verbose_name='業者',on_delete=models.CASCADE)
    product = models.CharField(verbose_name='商品名',max_length=50)
    barcode = models.PositiveIntegerField(verbose_name='バーコド',blank=True,null=True,max_length=12)
